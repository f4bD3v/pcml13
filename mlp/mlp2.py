...
class MultiLayerPerceptron:
	...
	def eval_train_err(self):
		...
		self.train_mis_class = ret[1]*100.0/(self.X.shape[0])
		self.train_cor_class = ret[2]*100.0/(self.X.shape[0])
		self.train_zerone = ret[1]*1./self.X.shape[0]
	...
	def eval_valid_err(self):
		...
		self.valid_zerone = ret[1]*1./self.Y_valid.shape[0]
		self.zerone = np.append(self.zerone, self.valid_zerone)
	...
	def disp_results(self):
		...
		print "correct classifications:  ",self.train_cor_class,"%"
		print "misclassifications:  ",self.train_mis_class,"%"
		print "0/1:  ",self.train_zerone,"%"
		...
		plt.savefig('plots/4_9/plot_'+str(self.h1)+'_'+str(self.eta_z)+'_'+str(self.mu)+'.png')
		#plt.show()
...
def main():
	...
	h1 = 10 
	#mlp = MultiLayerPerceptron(h1, 0.1, 0.015, 10, train_data, train_labels, valid_data, valid_labels)
